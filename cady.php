...
<body>
   ...
   <div class="set">
   	...
   	<form method="POST" action="cadybackend.php" class="unknow" >
    
     <br>
     <select name="flocation" class="type" required>
    ...
    <select name="tlocation" class="type" required>
    ...
    ?>
     ...
     <br><select class="type"  name="filter">
     <option> SORT BY </option>
     <option> ARRIVE HERE FIRST </option>
     <option> REACH DESTINATION FIRST </option>
     <option> MORE EMPTY SEATS </option>
         </select><br><br>
